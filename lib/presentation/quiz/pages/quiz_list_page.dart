...
class _QuizListPageState extends State<QuizListPage> {
  ...
  void initState() {
    context
        .read<QuizByCategoryBloc>()
        .add(const QuizByCategoryEvent.getQuizByCategory('Verbal'));
    super.initState();
  }
    ...
    return CustomScaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          BlocListener<QuizByCategoryBloc, QuizByCategoryState>(
            listener: (context, state) {
              state.maybeWhen(
                ...
                notfound: () {
                  context
                      .read<CreateTestBloc>()
                      .add(const CreateTestEvent.createTest());
                },
              );
            },
            child: BlocBuilder<QuizByCategoryBloc, QuizByCategoryState>(
